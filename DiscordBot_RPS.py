...
#RPS Rock Paper Scissors for Discord
#VERSION 0.3.5.D
...
def mainGame():
        ...
        def exceptionHandle():
                ...
                while userAnswerCont == False:
                        ...
                        break
        def versionNumber():
            versionNumberVar = "0.3.5.D"
            print("Version - " + versionNumberVar)
            #Version number should be read as "MAJOR#.MINOR#.UPDATE(.Type if Applicable I.E. "0.0.0.D for Discord")
            timeLapse()
        def bugList():
